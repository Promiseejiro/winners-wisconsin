...
export default function TeensMinistryPage() {
  ...
  return (
    <>
      {/* ===== HERO ===== */}
      <section className="relative w-full min-h-screen h-[60vh] overflow-hidden flex items-center text-center text-white">
        <Image
        ...
        >
          ...
          >
            {focusAreas.map((area, index) => (
              ...
              >
                <span className="text-white/90 text-sm md:text-base font-medium max-w-[140px] text-center leading-tight">
                  {area.title}
                </span>
              </motion.div>
            ))}
